...
if (isset($_POST['email']) && isset($_POST['senha'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        if (password_verify($senha, $usuario['senha'])) {
            ...
            // Bloqueia login se o admin estiver desativado
            if ((int)$usuario['ativo'] === 0) {
                $erro = "Esta conta está desativada. Entre em contato com outro administrador.";
            } else {
...
<div class="login-box">
    ...
    <?php if (isset($erro)): ?>
        <p class="msg msg--erro"><?= htmlspecialchars($erro) ?></p>
    <?php endif; ?>
