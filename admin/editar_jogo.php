...
<head>
  ...
  <style>
    /* Grid de 6 colunas para a tela de edição */
    .shelf-grid--6 {
      display: grid;
    ...
    /* Cards menores: nome menor para caber */
    .shelf-grid--6 .shelf-card__nome {
      font-size: 9px;
    }

    .shelf-grid--6 .shelf-card__edit-badge {
      font-size: 8px;
    }

    @media (max-width: 900px) {
      .shelf-grid--6 { grid-template-columns: repeat(4, 1fr); }
    }
    @media (max-width: 600px) {
      .shelf-grid--6 { grid-template-columns: repeat(3, 1fr); }
    }
  </style>
</head>
<body>
