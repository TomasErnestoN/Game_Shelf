    ...
    <div class="ea-form-col">
      <div class="ea-form-box">
        ...
        <?php else: ?>
          ...
          <div class="ea-form-placeholder" style="display:flex; flex-direction:column; align-items:center; text-align:center; color:#3c91b0;">
            <img src="../main/Capas/admin.png" alt="Admin" style="width:60px; margin-bottom:12px; opacity:0.5; display:block;">
